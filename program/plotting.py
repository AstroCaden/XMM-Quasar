...
def _plot_gamma_daox(self):
    ...
    colors = {"weak": "red", "normal": "black", "strong": "blue"}
    ...
    ax.axvline(self.xray_weak_threshold, color="red", linewidth=0.8, linestyle="--")
    ax.axvline(self.xray_strong_threshold, color="blue", linewidth=0.8, linestyle="--")
...
def _plot_counts_vs_daox(self):
    ...
    ax.axhline(self.xray_weak_threshold, color="red", linewidth=0.8, linestyle="--")
    ax.axhline(self.xray_strong_threshold, color="blue", linewidth=0.8, linestyle="--")
    ax.set_xscale("log")

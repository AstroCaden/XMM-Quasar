...
Updating with the corrected-code run's values — Γ_own/Γ_lit/σ from the new log, Δαox/HR/Fvar/Fit unchanged since the fix only touched the literature comparison, not those calculations.
